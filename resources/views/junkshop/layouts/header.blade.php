<header class="navbar navbar-expand-md d-print-none top sticky">
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-md-3 pe-0">
            <a href=".">
                <img class="navbar-brand-image" src="./assets/static/logo.svg" width="110" height="32"
                    alt="Tabler">
            </a>
        </h1>
        <div class="navbar-collapse collapse" id="navbar-menu">
            <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('junkshop.pages.index') }}">
                            <span
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                            href="#navbar-base" role="button" aria-expanded="false">
                            <span
                                ...
                                <div class="dropdown-menu-column">
                                    ...
                                    <div class="dropend">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="./sign-in-link.html">
                                                Sign in link
                                            </a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                            href="#navbar-extra" role="button" aria-expanded="false">
                            <span
                    ...
                    <li class="nav-item active dropdown">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                            href="#navbar-layout" role="button" aria-expanded="false">
                            <span
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                            href="#navbar-help" role="button" aria-expanded="false">
                            <span
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item text-pink" href="https://github.com/sponsors/codecalm"
                                ...
                                <svg class="icon icon-inline me-1" xmlns="http://www.w3.org/2000/svg" width="24"
